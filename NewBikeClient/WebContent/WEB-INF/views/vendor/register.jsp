...
<div class="alert alert-info">
 <a  href="<spring:url value="/vendor/login"> </spring:url>" class="alert-link"> ${requestScope.status} </a>
	...
	<br>
		...
		<a href="<spring:url value="/vendor/login"> </spring:url>" class="btn btn-warning btn-block "> Vendor Login  </a>	
		</div>

		<div class="form-group">
		<a href="<spring:url value="/user/login"> </spring:url>" class="btn btn-danger btn-block "> User Login  </a>	
		</div>
	...
	<div class="form-group">
      <label for="proof">Enter SHOP ACT Number</label>
